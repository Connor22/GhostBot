class Guild{
	...
	// functions
		...
		addVote(message, messageID, creatorID, channelID, voteCount, emojis, period){
		...
		getVoteNumber(){
			this.static.voteTracker.number += 1;
			return this.static.voteTracker.number;
		}
